...
const styles = StyleSheet.create({ content: { flex: 1, justifyContent: 'center' }, heading: { ...typography.heading, color: colors.textPrimary, textAlign: 'center' }, countdown: { ...typography.heading, color: colors.danger, marginTop: spacing.lg, textAlign: 'center' }, waiting: { ...typography.label, color: colors.danger, marginTop: spacing.sm, textAlign: 'center' }, message: { ...typography.body, color: colors.textSecondary, marginTop: spacing.md, textAlign: 'center' }, instruction: { ...typography.label, color: colors.textPrimary, marginTop: spacing.xl, textAlign: 'center' }, holdButton: { alignItems: 'center', backgroundColor: colors.primary, borderRadius: 16, marginTop: spacing.xl, overflow: 'hidden', padding: spacing.lg }, back: { marginTop: spacing.md }, pressed: { backgroundColor: colors.primaryPressed }, buttonText: { ...typography.label, color: colors.white, zIndex: 1 }, progress: { backgroundColor: colors.primaryPressed, bottom: 0, left: 0, position: 'absolute', top: 0 } });
